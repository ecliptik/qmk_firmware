...
[BASE] = LAYOUT_gergoplex(
    ...
    MT(MOD_RSFT, KC_A), KC_S, KC_D, KC_F, KC_G,    KC_H, KC_J, KC_K,    KC_L,   MT(MOD_LCTL, KC_SCLN),
    MT(MOD_LCTL, KC_Z), KC_X, KC_C, KC_V, KC_B,    KC_N, KC_M, KC_COMM, KC_DOT, MT(MOD_RSFT, KC_SLSH),
...
[NUMB] = LAYOUT_gergoplex(
    ...
    KC_F6, KC_F7, KC_F8, KC_F9, KC_F10,    KC_TRNS, KC_PGDOWN, KC_PGUP, KC_MUTE, KC_VOLD,
