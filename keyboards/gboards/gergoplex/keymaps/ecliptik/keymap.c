...
[SYMB] = LAYOUT_gergoplex(
    KC_EXLM, KC_AT, KC_LCBR, KC_RCBR, KC_PIPE,    KC_GRV,  KC_TILD, KC_DOUBLE_QUOTE, KC_TRNS, KC_BSLS,
 ...
 * |-----+-----+-----+-----+------|      |-------------------------------|
 * |  F6  | F7  | F8  | F9  | F10 |      |MLFT | KC_PGDOWN | KC_PGUP | KC_MUTE| VOLDN |
 * `------+-----+-----+------+----'      `-------------------------------'
 *      .-----------------.                   .-----------------.
 *      | F11 | F12|      |                   |     | PLY | SKP |
 *      '-----------------'                   '-----------------'
...
[NUMB] = LAYOUT_gergoplex(
    ...
    KC_F6, KC_F7, KC_F8, KC_F9, KC_F10,  KC_MS_L, KC_PGDOWN, KC_PGUP, KC_MUTE, KC_VOLD,
